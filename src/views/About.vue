<template>
  <div class="about w-full grid grid-cols-3">
    <div id="nav" class="absolute w-full p-12">
      <router-link to="/" class="text-black hover:text-gray-500 text-xl"
        >Home</router-link
      >
      |
...
export default {
  data(){
    return{
      nickname:"Lucky KL",
      name:"Kanokporn Buaycharoen",
      birth:"29 September 2000",
